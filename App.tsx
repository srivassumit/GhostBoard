...
import { FanPlay } from './components/FanPlay';
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-[#0a0a0c] text-slate-200 overflow-hidden">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex bg-black/40 rounded-lg p-1 border border-zinc-800 ml-4">
            <button
              ...
              className={`px-4 py-1.5 text-xs font-bold font-orbitron rounded transition-all ${activeTab === 'fanplay'
            ...
            <button
              ...
              className={`px-4 py-1.5 text-xs font-bold font-orbitron rounded transition-all ${activeTab === 'ghostplay'
      ...
      <main className="flex-1 relative overflow-hidden">
                    ...
                    <div className="flex gap-2">
                      ...
                      {state.simulationResult && (
                        <button
                          ...
                          className={`px-4 py-1.5 text-xs font-bold rounded border transition-colors ${state.showAnimation
                  ...
                  {!state.simulationResult && !state.isSimulating ? (
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
                      ...
                      <section>
                        ...
                        <div className={`text-3xl font-orbitron font-black ${state.simulationResult?.verdict === 'Goal Likely' ? 'text-emerald-500' :
        ...
        {/* === TAB 2: FANPLAY === */}
        <div className={activeTab === 'fanplay' ? "w-full h-full flex flex-col items-center justify-center animate-in fade-in zoom-in duration-300" : "hidden"}>
          <FanPlay />
        </div>
      </main>
